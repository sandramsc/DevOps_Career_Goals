...
|------------------------------------------|---------------------------------------------|------------------------------------------|-----------------------------------------------------------|--------------------------------------------------------------------|
| Python                                   | Python                                      | Python programming, Python for DevOps    | Python for Everybody: [Course](https://www.coursera.org/specializations/python) <br> Python for DevOps: [Course](https://www.youtube.com/watch?v=H21U4jX_SLQ&list=PLdpzxOOAlwvKwTyYNJCUwGPvql0TrsPgv) | [![GitLicense](https://img.shields.io/badge/InProgress--yellow.svg)](https://link.com)  |
