...
| IBM Applied DevOps Engineering           | Representational State Transfer (REST), Cloud Applications, Openshift, Microservices, Software Testing, Automated Testing, CI/CD, agile, TDD/BDD, Infrastructure As Code, Observability, Telemetry, Monitoring, Docke, Kubernetes, Container, Kanban, Zenhub, Scrum Methodology, Open Web Application Security Project (OWASP), Cloud Computings | [Course](https://www.ibm.com/skills/topics/full-stack-developer) IBM Applied DevOps Engineering  | [![GitLicense](https://img.shields.io/badge/InProgress--yellow.svg)](https://link.com)  |
