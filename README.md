...
| Containerization w/ Docker       | Dockers          | Docker    | Get Started with Docker: [Course](https://docs.docker.com/get-started/) <br> Docker Containers and Kubernetes Fundamentals: [Course](https://www.youtube.com/watch?v=kTp5xUtcalw&pp=ygULS1VCRVJFTkVURVM%3D) | [![GitLicense](https://img.shields.io/badge/Started--yellow.svg)](https://link.com)     |
| Container Orchestration        | Kubernetes          | Kubernetes   |  Kubernetes Basics: [Course](https://kubernetes.io/docs/tutorials/kubernetes-basics/) <br> Kubernetes Tutorial for Beginners: [Course](https://www.youtube.com/watch?v=X48VuDVv0do&pp=ygULS1VCRVJFTkVURVM%3D) | [![GitLicense](https://img.shields.io/badge/Started--yellow.svg)](https://link.com)     |
