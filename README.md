...
|------------------------------------------|---------------------------------------------|------------------------------------------|-----------------------------------------------------------|--------------------------------------------------------------------|
| Python                               | Python Scripting                                     | Python Scripting for DevOps    | Python for DevOps: [Course](https://www.youtube.com/watch?v=H21U4jX_SLQ&list=PLdpzxOOAlwvKwTyYNJCUwGPvql0TrsPgv) | [![GitLicense](https://img.shields.io/badge/InProgress--yellow.svg)](https://link.com)  |
| Python                                   | Data Structure, Python Programming, SQL , Sqlite,Data Visualization, Data Analysis, JSON,XML                                   | Python programming   | Python for Everybody: [Course](https://www.coursera.org/specializations/python) | [![GitLicense](https://img.shields.io/badge/Completed--lime.svg)](https://link.com)  |
...
| IBM Applied DevOps Engineering           | DevOps principles and tools | Representational State Transfer (REST), Cloud Applications, Openshift, Microservices, Software Testing, Automated Testing, CI/CD, agile, TDD/BDD, Infrastructure As Code, Observability, Telemetry, Monitoring, Docker, Kubernetes, Container, Kanban, Zenhub, Scrum Methodology, Open Web Application Security Project (OWASP), Cloud Computings   | IBM Applied DevOps Engineering: [Course](https://www.example.com) | [![GitLicense](https://img.shields.io/badge/Completed--lime.svg)](https://link.com)  |
