...
|------------------------------------------|---------------------------------------------|------------------------------------------|-----------------------------------------------------------|--------------|
| Scripting in Python  | Python for DevOps (scripting)       | Python programming   | Python for Everybody: [Course](https://www.coursera.org/specializations/python) | [![GitLicense](https://img.shields.io/badge/Completed--lime.svg)](https://link.com)  |
