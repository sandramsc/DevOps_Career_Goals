<h1 align="center">Devops Career Progression Roadmap</h1>
<p align="center">
...
|------------------------------------------|---------------------------------------------|------------------------------------------|-----------------------------------------------------------|--------------------------------------------------------------------|
| Python                               | Python Scripting for DevOps                                | Python (DSA not necessary, but good to have)   | Python for DevOps: [Course](https://www.youtube.com/watch?v=H21U4jX_SLQ&list=PLdpzxOOAlwvKwTyYNJCUwGPvql0TrsPgv) , Python for Everybody: [Course](https://www.coursera.org/specializations/python) | [![GitLicense](https://img.shields.io/badge/Started--yellow.svg)](https://link.com)  |
| Oracle         | Database (DB) Design, SQL, Database(DBSM)             |  Database design to database architecture and deployment.    | Oracle Database Foundations: [Course](https://www.coursera.org/learn/introduction-to-oracle-sql), Oracle SQL Databases: [Course](https://www.coursera.org/specializations/oracle-sql-databases) , Oracle Tutuorial: [Course](https://www.javatpoint.com/oracle-tutorial), Oracle SQL for Beginners: [Course](https://www.youtube.com/playlist?list=PLiLpmqwkwkCt0QeXD8j7BwIoOaBGBRrZC)| [![GitLicense](https://img.shields.io/badge/NotStarted--blue.svg)](https://link.com)     |
...
| Containerization w/ Docker       | Docker          | Docker    | Get Started with Docker: [Course](https://docs.docker.com/get-started/)  | [![GitLicense](https://img.shields.io/badge/Started--yellow.svg)](https://link.com)     |
...
| Goal                                     | Skills                                      | Technologies to Learn                         | Suggested Courses                                          | Progress     |
|------------------------------------------|---------------------------------------------|-----------------------------------------------|-----------------------------------------------------------|--------------|
| AWS Certified DevOps Engineer            | AWS for DevOps Engineers                         |  AWS | AWS for DevOps Engineers: [Course](https://www.coursera.org/specializations/exam-prep-dop-c02-aws-certified-devops-engineer--professional) | [![GitLicense](https://img.shields.io/badge/NotStarted--blue.svg)](https://link.com)   |
...
| Container Orchestration        | Kubernetes          | Kubernetes   |  Kubernetes Basics: [Course](https://kubernetes.io/docs/tutorials/kubernetes-basics/) <br> Kubernetes Tutorial for Beginners: [Course](https://www.youtube.com/watch?v=X48VuDVv0do&pp=ygULS1VCRVJFTkVURVM%3D) <br> Docker Containers and Kubernetes Fundamentals: [Course](https://www.youtube.com/watch?v=kTp5xUtcalw&pp=ygULS1VCRVJFTkVURVM%3D) | [![GitLicense](https://img.shields.io/badge/NotStarted--blue.svg)](https://link.com)     |
