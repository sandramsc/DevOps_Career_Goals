...
| Goal                                     | Skills                                      | Technologies to Learn                         | Suggested Courses                                          | Progress     |
|------------------------------------------|---------------------------------------------|-----------------------------------------------|-----------------------------------------------------------|--------------|
| AWS Cloud Practitioner Essentials                | AWS Cloud Practitioner Essentials                          |  AWS | AWS Cloud Practitioner Essentials: [Course](https://aws.amazon.com/training/course-descriptions/cloud-practitioner-essentials/) | [![GitLicense](https://img.shields.io/badge/NotStarted--blue.svg)](https://link.com)   |
...
| Containerization w/ Docker       | Dockers          | Docker    | Get Started with Docker: [Course](https://docs.docker.com/get-started/)  | [![GitLicense](https://img.shields.io/badge/Started--yellow.svg)](https://link.com)     |
