...
| Containerization w/ Docker       | Docker          | Docker    | Get Started with Docker: [Course](https://docs.docker.com/get-started/), DevOps w/ Docker: [Course](https://devopswithdocker.com/getting-started)   | [![GitLicense](https://img.shields.io/badge/Started--yellow.svg)](https://link.com)     |
...
| Container Orchestration        | Kubernetes          | Kubernetes   |  Kubernetes Basics: [Course](https://kubernetes.io/docs/tutorials/kubernetes-basics/) <br> Kubernetes Tutorial for Beginners: [Course](https://www.youtube.com/watch?v=X48VuDVv0do&pp=ygULS1VCRVJFTkVURVM%3D) <br> DevOps w/ Kubernetes : [Course](https://devopswithkubernetes.com/) | [![GitLicense](https://img.shields.io/badge/NotStarted--blue.svg)](https://link.com)     |
